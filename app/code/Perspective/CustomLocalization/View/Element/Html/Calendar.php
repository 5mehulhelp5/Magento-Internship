 ...
 */
namespace Perspective\CustomLocalization\View\Element\Html;
...
class Calendar extends \Magento\Framework\View\Element\Template
{
    ...
    protected function _toHtml()
    {
        ...
        // get "am" & "pm" words
            //Fix(without this fix admin localization crashed)
            //Source: https://github.com/magento/magento2/issues/38214
            //(my mage version 2.4.7, but it fixed on 2.4.8)
